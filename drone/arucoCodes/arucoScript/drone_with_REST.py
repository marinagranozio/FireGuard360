...
static_path = "/Users/asus/Documents/Università/MAGISTRALE/CPS/Tesina"  #!!!!!!! Da cambiare con il Path assoluto in cui si trova il modello best.pt!!!!!
path_to_image = static_path + "/verifica_incendio.jpg"
path_to_model = static_path + "/best.pt"

url = 'http://localhost:5000/fire_detection'
